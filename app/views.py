...
# --- DATOS EXTRAÍDOS Y ADAPTADOS AL ESTILO ESTRUCTURAL DEL TFG ---
MARIO_PERSPECTIVES = {
    "mario": {
        "verbose": "El edificio Mario opera dentro del Distrito de Juego Principal. Gestiona la representación visual del jugador, respondiendo a las coordenadas dictadas por MarioMover. Se coordina mediante variables de estado para determinar su vulnerabilidad, colisiones y ataques. Además, interactúa con el sistema de puntuación al recoger objetos y responde a eventos broadcast para sincronizar animaciones y sonidos, asegurando una retroalimentación visual inmediata.",
        "schematic": "<ul><li><b>Función principal:</b> Representación visual e interacción directa del jugador.</li><li><b>Controla:</b> Animaciones, visibilidad y efectos gráficos según estados de vulnerabilidad.</li><li><b>Interactúa con:</b> MarioMover (para posición), enemigos y objetos coleccionables.</li><li><b>Variables / Eventos:</b> Responde a colisiones físicas y broadcasts de inicio de nivel.</li><li><b>Contribuye a:</b> La jugabilidad central y la coherencia visual del personaje.</li></ul>"
    },
    "mariomover": {
        "verbose": "MarioMover actúa como el controlador físico central (motor de movimiento) dentro del Distrito de Juego. Gestiona las variables globales de dirección actual y deseada, calculando posiciones y respondiendo a colisiones estructurales con el escenario. Coordina eventos de movimiento mediante broadcasts como PipeWarped, separando el cálculo espacial de la representación visual de Mario.",
        "schematic": "<ul><li><b>Función principal:</b> Motor físico y cálculo de coordenadas del jugador.</li><li><b>Controla:</b> Variables de dirección, orientación, velocidad y límites espaciales.</li><li><b>Coordina con:</b> Mario (transmisión de coordenadas) y Joystick (recepción de inputs).</li><li><b>Variables / Eventos:</b> Emite/recibe broadcast PipeWarped, eventos de colisión con entorno.</li><li><b>Lógica de control:</b> Traduce la entrada del usuario en desplazamiento físico consistente.</li></ul>"
    },
    "coin": {
        "verbose": "El edificio Coin forma parte del Distrito de Recompensas. Regula su propia visibilidad en respuesta a variables de estado y eventos de nivel. Al detectar colisión (touching) con Mario, desencadena la actualización de variables de puntuación y emite efectos sonoros. Su recolección está sincronizada con broadcasts del sistema para asegurar que el progreso se refleje correctamente.",
        "schematic": "<ul><li><b>Función principal:</b> Objeto coleccionable interactivo.</li><li><b>Interactúa con:</b> Mario (detección de colisión).</li><li><b>Variables / Eventos:</b> Actualiza variables de puntuación y responde a eventos de reinicio.</li><li><b>Controla:</b> Su propia visibilidad, animaciones y reproducción de efectos sonoros.</li><li><b>Contribuye a:</b> Establecimiento de objetivos a corto plazo y motivación del jugador.</li></ul>"
    },
    "mainstars": { 
        "verbose": "MainStars funciona dentro del Distrito de Recompensas como un coleccionable de alto valor. Su lógica es paralela a Coin: controla su aparición según el estado de la partida y, al interactuar con Mario, desencadena actualizaciones críticas de progreso. Su coordinación con broadcasts garantiza que la recogida influya en los sistemas de nivel, alterando el ritmo del juego.",
        "schematic": "<ul><li><b>Función principal:</b> Objeto coleccionable estructurador de avance.</li><li><b>Interactúa con:</b> Mario (colisión) y sistemas de nivel.</li><li><b>Variables / Eventos:</b> Desencadena actualizaciones de puntuación mayor y cambios de estado.</li><li><b>Lógica de control:</b> Gestiona su aparición basada en temporización o eventos específicos.</li><li><b>Contribuye a:</b> El equilibrio entre desafío y recompensa principal.</li></ul>"
    },
    "browser": {
        "verbose": "Bowser actúa como la entidad enemiga principal (jefe) en el Distrito de Juego. Delega su cálculo espacial al edificio BowserMover, dedicándose a la actualización de disfraces y efectos según variables de vulnerabilidad o daño. Las colisiones con Mario evalúan condiciones de estado para desencadenar broadcasts de reinicio (daño) o eventos de victoria, coordinándose con sonidos y temporizadores.",
        "schematic": "<ul><li><b>Función principal:</b> Entidad enemiga principal (representación visual e interacción).</li><li><b>Interactúa con:</b> BowserMover (posición) y Mario (evaluación de daño/colisión).</li><li><b>Variables / Eventos:</b> Lee variables de estado de vulnerabilidad; emite broadcasts de impacto o GameOver.</li><li><b>Controla:</b> Cambios de disfraz continuos y efectos gráficos de estado.</li><li><b>Lógica de control:</b> Define el nivel de peligro activo en el escenario.</li></ul>"
    },
    "redbrowser": {
        "verbose": "Variante de entidad enemiga principal en el Distrito de Juego. Su estructura lógica replica la delegación espacial a un Mover, enfocándose en la gestión visual y las reglas de interacción con el jugador. Responde a cambios de estado globales para alterar su nivel de amenaza visual y coordina eventos de colisión que pueden resultar en penalizaciones críticas para el jugador.",
        "schematic": "<ul><li><b>Función principal:</b> Entidad enemiga autónoma (representación visual).</li><li><b>Interactúa con:</b> Su sprite controlador de posición y Mario.</li><li><b>Variables / Eventos:</b> Responde a variables de amenaza y broadcasts del sistema de colisiones.</li><li><b>Controla:</b> Apariencia, disfraces y emisión de señales de impacto.</li><li><b>Contribuye a:</b> Escalado de dificultad y variedad de desafíos.</li></ul>"
    },
    "blueenemy": {
        "verbose": "Edificio correspondiente a enemigos estándar que operan de forma autónoma. Se asocian a controladores de choque para definir patrones de patrulla. Actualizan su estado visual basándose en si son vulnerables o representan amenaza. Sus colisiones con Mario envían broadcasts de daño o generan recompensas, integrándose en el ciclo de riesgo/recompensa del sistema.",
        "schematic": "<ul><li><b>Función principal:</b> Patrulla y obstáculo dinámico.</li><li><b>Coordina con:</b> Controladores auxiliares de detección de colisión de paredes.</li><li><b>Variables / Eventos:</b> Variables de estado de vulnerabilidad; broadcasts de reinicio/recompensa.</li><li><b>Lógica de control:</b> Desplazamiento continuo y actualización de disfraces según estado.</li><li><b>Contribuye a:</b> Dinámica constante de evitación e interacción en el escenario.</li></ul>"
    },
    "blue": {
        "verbose": "Variante de enemigo autónomo estándar en el Distrito de Juego. Se asocia a controladores de choque para definir patrones de patrulla. Actualiza su estado visual basándose en si es vulnerable o representa amenaza. Su colisión con Mario envía broadcasts de daño o genera recompensas, integrándose en el ciclo de riesgo/recompensa del sistema global.",
        "schematic": "<ul><li><b>Función principal:</b> Patrulla y obstáculo dinámico.</li><li><b>Coordina con:</b> Controladores auxiliares de detección de colisión de paredes.</li><li><b>Variables / Eventos:</b> Variables de estado de vulnerabilidad; broadcasts de reinicio/recompensa.</li><li><b>Lógica de control:</b> Desplazamiento continuo y actualización de disfraces según estado.</li><li><b>Contribuye a:</b> Dinámica constante de evitación e interacción en el escenario.</li></ul>"
    },
    "greenenemy": {
        "verbose": "Variante de enemigo autónomo estándar en el Distrito de Juego. Se asocia a controladores de choque para definir patrones de patrulla. Actualiza su estado visual basándose en si es vulnerable o representa amenaza. Su colisión con Mario envía broadcasts de daño o genera recompensas, integrándose en el ciclo de riesgo/recompensa del sistema global.",
    ...
    "bomb": {
        "verbose": "Elemento de peligro interactivo temporal en el Distrito de Juego. Su lógica está estrictamente condicionada a temporizadores internos que regulan su ciclo de aparición, animación de tamaño (alerta visual) y detonación. Al colisionar con el jugador, emite broadcasts de penalización o reinicio, actuando como un factor de riesgo estratégico.",
        "schematic": "<ul><li><b>Función principal:</b> Objeto de riesgo con temporización.</li><li><b>Interactúa con:</b> Mario (colisión durante fase activa).</li><li><b>Variables / Eventos:</b> Temporizadores internos y broadcasts de daño.</li><li><b>Controla:</b> Ciclos de visibilidad, animación de expansión y efectos de sonido.</li><li><b>Contribuye a:</b> Controlar el ritmo y forzar decisiones estratégicas del jugador.</li></ul>"
    },
    "mazechanger": {
        "verbose": "Edificio perteneciente al Distrito de Entorno/Sistema. Funciona como controlador estructural del nivel, escuchando broadcasts de avance para ordenar modificaciones en el trazado del laberinto. Coordina el re-posicionamiento de entidades y asegura la coherencia espacial durante transiciones de fase o después de eventos de reinicio.",
        "schematic": "<ul><li><b>Función principal:</b> Controlador de estado del entorno estructural.</li><li><b>Interactúa con:</b> Sprites de paredes, backdrops y entidades del juego.</li><li><b>Variables / Eventos:</b> Responde a eventos de avance de nivel o reseteo.</li><li><b>Lógica de control:</b> Redefine el espacio de colisión y ubicación de los sprites.</li><li><b>Contribuye a:</b> Continuidad del sistema y progresión de dificultad del entorno.</li></ul>"
    },
    "backdrips": {
        "verbose": "Elemento de soporte en el Distrito de Entorno. Se sincroniza con eventos del sistema para modificar la capa visual subyacente del nivel, asegurando que la estética coincida con el estado de progreso. Se coordina mediante broadcasts para ejecutar transiciones sin interferir en la capa física de colisiones.",
        "schematic": "<ul><li><b>Función principal:</b> Soporte visual y estético del nivel.</li><li><b>Coordina con:</b> Stage y controladores de estado del entorno.</li><li><b>Variables / Eventos:</b> Cambios de fase y broadcasts de nivel.</li><li><b>Lógica de control:</b> Actualiza disfraces/fondos para contextualizar la acción.</li><li><b>Contribuye a:</b> La inmersión visual y coherencia narrativa espacial.</li></ul>"
    },
    "score": {
        "verbose": "Edificio principal del Distrito de Puntuación e Interfaz. Gestiona la representación numérica de las variables de recolección en tiempo real. Utiliza un sistema de creación de clones para instanciar dígitos individuales, organizando su posición (X/Y) basándose en eventos de actualización (broadcasts) originados por la recogida de objetos.",
        "schematic": "<ul><li><b>Función principal:</b> Visualización del progreso numérico en pantalla.</li><li><b>Controla:</b> Creación y posicionamiento de clones (dígitos).</li><li><b>Variables / Eventos:</b> Lee variables Score globales y recibe broadcasts de actualización.</li><li><b>Interactúa con:</b> Elementos recolectables (Coin, MainStars) de forma indirecta.</li><li><b>Lógica de control:</b> Dibuja o elimina información visual según estados (Ej: inicio, GameOver).</li></ul>"
    },
    "high": {
        "verbose": "Pertenece al Distrito de Puntuación. Su lógica replica el sistema de instanciación de clones de 'Score', pero orientado a mostrar récords persistentes (High Score). Se actualiza mediante validaciones lógicas contra la variable de puntuación máxima y escucha eventos del sistema para mostrarse estratégicamente en menús o pantallas de Game Over.",
        "schematic": "<ul><li><b>Función principal:</b> Visualización de la puntuación máxima histórica.</li><li><b>Controla:</b> Creación de clones para representación numérica estática.</li><li><b>Variables / Eventos:</b> Lee variable de Récord; responde a estados de Menú y GameOver.</li><li><b>Contribuye a:</b> Retención del jugador mediante el establecimiento de metas a largo plazo.</li></ul>"
    },
    "level": {
        "verbose": "Edificio de Interfaz que indica visualmente la fase actual. Se actualiza mediante cambios de disfraz activados por broadcasts de transición de nivel (enviados por MazeChanger u otros controladores). Su visibilidad está estrictamente ligada al estado de 'Juego Activo', ocultándose en menús iniciales.",
        "schematic": "<ul><li><b>Función principal:</b> Indicador visual del estado de progresión.</li><li><b>Controla:</b> Cambios de disfraz asociados al valor de la variable de Nivel.</li><li><b>Variables / Eventos:</b> Sincronizado con broadcasts de avance de fase y estado de juego.</li><li><b>Contribuye a:</b> Proporcionar contexto situacional inmediato al jugador.</li></ul>"
    },
    "awesome!": {
        "verbose": "Edificio del Distrito de Retroalimentación y Recompensas. Se activa de forma condicional mediante broadcasts asociados a eventos de éxito crítico (recolección mayor o fin de nivel). Su rutina incluye interpolaciones de movimiento, transparencia y la ejecución de secuencias de audio para reforzar positivamente la acción del jugador.",
        "schematic": "<ul><li><b>Función principal:</b> Emisión de feedback visual y sonoro positivo.</li><li><b>Interactúa con:</b> Eventos de éxito del sistema de progreso.</li><li><b>Variables / Eventos:</b> Broadcasts de recompensa y temporizadores de animación.</li><li><b>Lógica de control:</b> Ejecuta rutinas secuenciales visuales y vuelve a ocultarse.</li><li><b>Contribuye a:</b> Enriquecimiento de la experiencia de usuario y motivación.</li></ul>"
    },
    "level_up2": {
        "verbose": "Forma parte del Distrito de Retroalimentación. Reacciona a los eventos del sistema que indican avance de etapa, desencadenando animaciones estéticas y secuencias de sonido. Coordina su aparición visual de forma asíncrona a la mecánica física, asegurando no interrumpir la jugabilidad central mientras informa al usuario.",
        "schematic": "<ul><li><b>Función principal:</b> Emisión de feedback visual de transición de fase.</li><li><b>Interactúa con:</b> Eventos de progreso y avance de nivel.</li><li><b>Variables / Eventos:</b> Broadcasts de subida de nivel.</li><li><b>Lógica de control:</b> Animación interpolada temporal.</li><li><b>Contribuye a:</b> Celebración de metas y refuerzo positivo.</li></ul>"
    },
    "praiseme": {
        "verbose": "Elemento de Retroalimentación condicional. Actúa sobre la base de broadcasts derivados de la recolección o logros de puntuación. Aplica modificaciones gráficas (cambios de tamaño, transparencia) y se desactiva por sí mismo al finalizar su ciclo lógico. Su arquitectura es puramente visual y reactiva.",
        "schematic": "<ul><li><b>Función principal:</b> Emisión de feedback visual de logro de puntuación.</li><li><b>Interactúa con:</b> Eventos del sistema de Puntuación.</li><li><b>Variables / Eventos:</b> Broadcasts de éxito.</li><li><b>Lógica de control:</b> Modificación de propiedades gráficas de forma temporal.</li><li><b>Contribuye a:</b> Recompensa psicológica del jugador.</li></ul>"
    },
    "aweepictastic": {
        "verbose": "Elemento cúspide del Distrito de Retroalimentación. Configurado para responder exclusivamente a los broadcasts de máximo logro del sistema. Concentra múltiples efectos simultáneos (disfraces, sonido, movimiento) para maximizar la gratificación visual del usuario tras completar eventos complejos del juego.",
        "schematic": "<ul><li><b>Función principal:</b> Emisión de feedback de máxima prioridad y espectacularidad.</li><li><b>Interactúa con:</b> Logros finales o recolecciones de alta dificultad.</li><li><b>Variables / Eventos:</b> Broadcasts condicionales complejos.</li><li><b>Lógica de control:</b> Ejecución de secuencias multimedia estructuradas.</li><li><b>Contribuye a:</b> Cierre emocional y satisfacción de la experiencia de juego.</li></ul>"
    },
    "joystick": {
        "verbose": "Edificio principal del Distrito de Interfaz de Entrada (Input). Procesa las interacciones del ratón/táctil, calculando deltas posicionales para establecer variables continuas de velocidad y ángulo. Estas variables son leídas por el edificio MarioMover para actualizar la capa física. Envía broadcasts regulares de actualización de estado de movimiento.",
        "schematic": "<ul><li><b>Función principal:</b> Captura y procesamiento de entradas (inputs) del usuario.</li><li><b>Controla:</b> Conversión de puntero X/Y en vectores de dirección.</li><li><b>Interactúa con:</b> MarioMover (escribe las variables que este lee).</li><li><b>Variables / Eventos:</b> Actualiza variables globales de velocidad y orientación en bucle.</li><li><b>Contribuye a:</b> Control responsivo y puente entre jugador y motor físico.</li></ul>"
    },
    "stage": {
        "verbose": "El Stage actúa como gestor global y soporte visual del entorno. Se encarga de inicializar sistemas, modificar el fondo (backdrop) según las fases del laberinto y emitir los broadcasts fundacionales (start, GameStart, GameOver). Mantiene la sincronización organizando las capas visuales de renderizado de todos los distritos.",
        "schematic": "<ul><li><b>Función principal:</b> Controlador global del escenario y gestor de fondos.</li><li><b>Controla:</b> Transiciones de backdrops y organización de capas (Front/Back).</li><li><b>Interactúa con:</b> Todos los distritos mediante emisiones globales de estado.</li><li><b>Variables / Eventos:</b> Inicialización de partida, cambios de fase y fin de juego.</li><li><b>Lógica de control:</b> Establece el contexto visual y sonoro base del programa.</li></ul>"
    },
    "bowsermover": {
        "verbose": "Actúa como el motor físico autónomo para la entidad jefe, operando dentro del Distrito de Juego de manera invisible. Ejecuta algoritmos de ruta y calcula colisiones contra el escenario, actualizando variables de coordenadas. Permite separar la carga computacional de movimiento de la carga de renderizado del sprite visual de Bowser.",
        "schematic": "<ul><li><b>Función principal:</b> Motor físico y de enrutamiento para enemigo final.</li><li><b>Controla:</b> Variables de posición y trayectorias espaciales.</li><li><b>Coordina con:</b> Sprite visual Bowser (escribe sus variables de ubicación).</li><li><b>Lógica de control:</b> Resolución de colisiones estructurales sin intervención visual.</li><li><b>Contribuye a:</b> Rendimiento fluido y separación de responsabilidades en la arquitectura.</li></ul>"
    },
    "title_page": {
        "verbose": "Edificio central del Distrito de Menú e Interfaz Inicial. Gestiona el estado de 'Espera' de la aplicación. Captura la atención del usuario e impide la activación de las rutinas de movimiento de los distritos de juego hasta recibir el trigger correspondiente (clic). Al ocultarse, emite broadcasts para iniciar los bucles de la partida.",
        "schematic": "<ul><li><b>Función principal:</b> Controlador del estado inicial de menú.</li><li><b>Controla:</b> Interfaz de bienvenida y bloqueo de mecánicas de fondo.</li><li><b>Interactúa con:</b> Variables de estado de partida (isGameStart).</li><li><b>Variables / Eventos:</b> Envía/recibe eventos de transición de inicio de juego.</li><li><b>Contribuye a:</b> Entrada estructurada y presentación profesional de la aplicación.</li></ul>"
    }
}
...
def format_babia_dict(d: dict):
    ...
    for sprite_key, sprite_item in global_babia['sprites'].items():
        ...
        sprite_district = {
            "id": sprite_key.replace(' ', '_'),    # Nombre del Sprite (se verá flotando)
